...
<div class="header_section">
	...
	<div class="layout_padding banner_section" >
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h1 class="banner_taital" style=" align-content: center; margin-top: 80px; margin-bottom: 100px" >ADMIN LOG IN </h1>
								...
								<div class="row"  style="margin-left: 10%; ">
									...
									<div class="col-sm-8">
										<div class="form-group">
											Email:  <input type="email" class="email_boton" placeholder="Email" name="Email">
										</div>
									</div>
									<div class="col-sm-8">
										<div class="form-group">
											Password: <input type="password" class="email_boton" placeholder="Password" name="password">
										</div>
									</div>

									<div class="col-sm-7">
										<div class="form-group">
										   <br> <button class="search_bt" type="submit" >Log In</button>
									...
									<br><div style=" font-size: larger; color: rgb(14, 55, 190); margin-left:30%; margin-right: 30%; text-align: right;">
										...
										<a href="./Register.jsp" style="color:blue;">New User? Register</a>
								</div>
